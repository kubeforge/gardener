...
// DeployKube2IAMResources - Not needed on KubeVirt
func (b *KubeVirtBotanist) DeployKube2IAMResources() error {
	return nil
}

// DestroyKube2IAMResources - Not needed on KubeVirt.
func (b *KubeVirtBotanist) DestroyKube2IAMResources() error {
	return nil
}

// GenerateKube2IAMConfig - Not needed on KubeVirt.
func (b *KubeVirtBotanist) GenerateKube2IAMConfig() (map[string]interface{}, error) {
...
func (b *KubeVirtBotanist) GenerateStorageClassesConfig() (map[string]interface{}, error) {
...
func (b *KubeVirtBotanist) GenerateNginxIngressConfig() (map[string]interface{}, error) {
